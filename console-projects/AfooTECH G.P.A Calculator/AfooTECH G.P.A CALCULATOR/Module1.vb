Module Module1
    ...
    Sub Main()
        ...
        Dim Gradepoint1, Gradepoint2, Gradepoint3, Gradepoint4, Gradepoint5, Gradepoint6 As Double
        Dim GPA, TGP, TCU As Double




        'Console.WriteLine("SOFTWARE TO CALCULATE AfooTECH G.P.A CALCULATOR  ")
        ...
        TCU = 25
        GPA = TGP / TCU
        Console.WriteLine("The GPA = " + GPA.ToString("N2"))
        ...
        Dim GradepointA, GradepointB, GradepointC, GradepointD, GradepointE, GradepointF As Double
        Dim GPA2, TGP2, TCU2, CGPA, CCGPA As Double
        ...
        CGPA = (TCU + TCU2) / 2
        Console.WriteLine("C.G.P.A =" + CGPA.ToString)
