    ...
    Sub Main()
        ...
        If choose = 1 Then
            ...
            If pick = 1 Then
                ...
                Console.WriteLine("Enter score for (Computer Programming Using c/c++ Language) ---- CTE313----(2 Units )")
                ...
                Console.WriteLine("Enter score for (Operating System II) ---- CTE314----(2 Units )")
                ...
                Console.WriteLine("Enter score for (Electronic Design and Prototyping)--------- CTE315----(2 Units )")
                ...
                Console.WriteLine("Enter  score for (Computer Installation and Maintenance)------- CTE316----(3 Units )")
                ...
                Console.WriteLine("Enter score for (Electrical Circuit Theory III)--------- EEC313----(2 Units )")
                ...
                Console.WriteLine("Enter score for (Electrical Measurement and Instrumentation)------ EEC314----(2 Units )")
                ...
                Console.WriteLine("Enter score for (Electonics III)------ EEC315----(2 Units )")
                ...
                Console.WriteLine("Enter score for (Telecommunications II)------ EEC316----(3 Units )")
                ...
                Console.WriteLine("Enter score for Engineering In Society)------ GNS311----(2 Units )")
                ...
                Console.WriteLine("Mathematics III(Advanced Algebra)------ MTH311----(2 Units )")
            ...
            Dim Gradepoint11, Gradepoint12, Gradepoint13, Gradepoint14, Gradepoint15, Gradepoint16, Gradepoint17, Gradepoint18, Gradepoint19, Gradepoint20 As Double
            ...
            If pick = 2 Then
                ...
                Console.WriteLine("Enter score for (Computer Hardware System Design) ---- CTE321----(2 Units )")
                ...
                Console.WriteLine("Enter score for (Wireless and Wireless Communication) ---- CTE322----(2 Units )")
                ...
                Console.WriteLine("Enter score for (Python Programming)--------- CTE323----(2 Units )")
                ...
                Console.WriteLine("Enter  score for (Electrical Circuit Theory IV)------- EEC323----(3 Units )")
                ...
                Console.WriteLine("Enter score for (Control Engineering I)--------- EEC324----(3 Units )")
                ...
                Console.WriteLine("Enter score for (Testing Methods and Reliability)------ EEC328----(2 Units )")
                ...
                Console.WriteLine("Enter score for (Electronics IV)------ EEC325----(2 Units )")
                ...
                Console.WriteLine("Enter score for (Industrial Management)------ GNS322----(2 Units )")
                ...
                Console.WriteLine("Enter score for (Communication In English II)------ GNS323----(2 Units )")
                ...
                Console.WriteLine("Mathematics (Advanced Calculus)------ MTH322----(2 Units )")
        ...
        If choose = 2 Then
            ...
            If pick = 1 Then
                ...
                Console.WriteLine("Enter score for (Computer Hardware System Design) ---- CTE3410----(2 Units )")
                ...
                Console.WriteLine("Enter score for (Wireless and Wireless Communication) ---- CTE411----(2 Units )")
                ...
                Console.WriteLine("Enter score for (Python Programming)--------- CTE412----(2 Units )")
                ...
                Console.WriteLine("Enter  score for (Electrical Circuit Theory IV)------- CTE413----(2 Units )")
                ...
                Console.WriteLine("Enter score for (Control Engineering I)--------- CTE414----(2 Units )")
                ...
                Console.WriteLine("Enter score for (Testing Methods and Reliability)------ EEC415----(2 Units )")
                ...
                Console.WriteLine("Enter score for (Electronics IV)------ EEC416----(2 Units )")
                ...
                Console.WriteLine("Enter score for (Industrial Management)------ GNS417----(2 Units )")
                ...
                Console.WriteLine("Enter score for (Communication In English II)------ MTH418----(2 Units )")
                ...
                Console.WriteLine("Mathematics (Advanced Calculus)------ CTE419----(1 Units )")
            ...
            Dim Gradepoint01, Gradepoint02, Gradepoint03, Gradepoint04, Gradepoint05, Gradepoint06, Gradepoint07, Gradepoint08 As Double
            ...
            If pick = 2 Then
                ...
                Console.WriteLine("Enter score for (Microprocessor In Control and Instrumentation) ---- CTE421----(3 Units )")
                ...
                Console.WriteLine("Enter score for (Artificial Inteligence) ---- CTE422----(3 Units )")
                ...
                Console.WriteLine("Enter score for (Seminar)--------- CTE423----(2 Units )")
                ...
                Console.WriteLine("Enter  score for (Project Management)-------  CTE424----(2 Units )")
                ...
                Console.WriteLine("Enter score for (Digital Signal Process)--------- CTE428----(3 Units )")
                ...
                Console.WriteLine("Enter score for (Project II)------ CTE429----(6 Units )")
                ...
                Console.WriteLine("Enter score for (Microcontroller Programming Pratical)------ ICT425----(1 Units )")
                ...
                Console.WriteLine("Enter score for (Mathematics iv(Statidtics method))------ MTH423----(2 Units )")
